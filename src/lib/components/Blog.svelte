<div class="pt-12">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		...
		>
			<a href="#">
				<article
					class="scale-102 to-90%0 flex transform flex-col items-start gap-3 rounded-2xl bg-gradient-to-r from-[#ff80b5] to-[#9089fc] transition-transform hover:shadow-lg"
				>
